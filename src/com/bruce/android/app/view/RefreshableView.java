package com.bruce.android.app.view;
...
public class RefreshableView extends LinearLayout implements OnTouchListener{  
    ...
    public RefreshableView(Context context, AttributeSet attrs) {  
        ...
        arrow = (ImageView) header.findViewById(R.id.head_arrowImageView);  
        description = (TextView) header.findViewById(R.id.head_tipsTextView);  
        updateAt = (TextView) header.findViewById(R.id.head_lastUpdatedTextView);  
